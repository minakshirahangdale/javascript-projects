...
// Give Feedback to user using toast- toasify website se link dalna rehta hai html file me .
...
const randomNumber = (min, max) => {
     return Math.floor(Math.random() * (max - min + 1) + min);  // is se max and min vala number genrate hota hai ye uska function hai mozrela se liye hai 
};
